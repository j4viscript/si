...
const mostrar = (pokemon) => {
    ...
    document.getElementById("xp").innerHTML = `${pokemon.experiencia} <span class="badge bg-primary">xp</span>`;
    document.getElementById("atk").innerHTML = `${pokemon.ataque} <span class="badge bg-danger">Atk</span>`;
